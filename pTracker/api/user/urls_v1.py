...
urlpatterns = [
  ...
  # url(r'login/', VersionExpiredLoginView.as_view(), name='custom_login_v1'),
  #  url(r'2fa/token-verify/', VersionExpiredView.as_view(), name='2fa_token_verify_v1'),
  #  url(r'logout/', VersionExpiredView.as_view(), name='custom_logout_v1'),

  #  path('get-employee-profile/<int:emp_id>/', VersionExpiredView.as_view(), name='get_employee_detail_profile_v1'),
  #  path('get-team-members/', VersionExpiredView.as_view(), name='get_team_members_v1'),
  #  path('get-request-count/', VersionExpiredView.as_view(), name='get_request_count_v1'),

  #  path('dashboard/', VersionExpiredView.as_view(), name='dashboard_anniversaries_v1'),
  #  #path('get-team-stats/<str:date>/<int:page>/', GetTeamStatsView_V1.as_view(), name='team_stats_v1'),
  #  #path('get-team-stats/<str:date>/<int:page>/<str:searchKeyword>/', GetTeamStatsViewbyKeyword_V1.as_view(), name='team_stats_v1'),
  #  path('get-application-data/', VersionExpiredView.as_view(), name='get_application_data_v1'),

  #   path('reset-password/', VersionExpiredView.as_view(),name="request_reset_email"),
  #   path('password-reset-complete/', VersionExpiredView.as_view(),name='password-reset-complete'),
  #   path('api-check/', VersionExpiredView.as_view(),name='api-check'),
  #  #  path('get-vesion-status/', GetVersionStatus.as_view(),name='get_vesion_status'),

  #    path('save-employee-profile/', VersionExpiredView.as_view(),name='save_employee_profile'),
  #    path('get-pending-profile-approvals/', VersionExpiredView.as_view(),name='get_employee_details_awaiting_approval'),
  #    path('get-profile-info-awaiting-approval/<int:emp_id>/', VersionExpiredView.as_view(),name='get_profile_info_awaiting_approval'),
  #    path('apply-action-on-profile-field/', VersionExpiredView.as_view(),name='apply_action_on_profile_field'),

  #    path('biometric-authentication/', VersionExpiredView.as_view(), name='biometric_authentication'),
  #    path('register-for-biometric-authentication/', VersionExpiredView.as_view(),name='biometric_authentication'),

  #    path('save-employee-profile-image/', VersionExpiredView.as_view(),name='save_employee_profile_image'),
